...
<head>
    ...
    <style>
        /* Custom CSS bisa ditambahkan di sini */
            ...
            width: 100%;
            height: 100%;
            object-fit: cover; /* Membuat gambar menutupi seluruh area "Right Box" */
        }

        /* Mengubah warna tombol register menjadi kuning */
            .btn-primary {
            background-color: #F5EE42;
            color: #000;
    ...
    <div class="container-fluid min-vh-100 bg-light d-flex justify-content-center align-items-center">
        ...
        <div class="row border rounded-3 shadow-lg" style="max-width: 900px;">
            ...
            <div class="col-md-6 p-5 left-box">
                <img src="{{ asset('images/logo.png') }}" class="img-fluid mb-4" alt="Logo" style="width: 100px;">
                <h2>Register</h2>
                ...
                <form action="{{ route('register') }}" method="post">
                    ...
                    <div class="mb-3">
                        <input type="submit" class="btn btn-primary w-100" value="Register"> <!-- Menambahkan kelas w-100 -->
                    </div>
                </form>
            </div>
            ...
            <div class="col-md-6 p-0 rounded-end" style="background: #103cbe;">
                <img src="{{ asset('images/right_box_image.jpeg') }}" class="right-box-image" alt="Right Box Image"> <!-- Mengganti dengan gambar -->
            </div> 
        </div>
    </div>
